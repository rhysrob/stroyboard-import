            ...
            for table in tables:
              ...
              # Spot the mistake card
                ...
                if 'Fill the gaps – dropdown'.lower() in table.rows[0].cells[0].text.lower():
                    ...
                    messages.error(
                        request, f'Fill the gaps dropdown card in Lesson {lesson_number}, Screen {screen_number}, make sure is correct {table.rows[0].cells[0].text}')
                ...
                if 'Fill the gaps – Typing'.lower() in table.rows[0].cells[0].text.lower():
                    ...
                    messages.error(
                        request, f'Fill the gaps – Typing  card in Lesson {lesson_number}, Screen {screen_number}, add content {table.rows[0].cells[0].text}')
                ...
                if 'Question & Answer'.lower() in table.rows[0].cells[0].text.lower():
                    ...
                    messages.error(
                        request, f'Question & Answer card in Lesson {lesson_number}, Screen {screen_number}, add content {table.rows[0].cells[0].text}')
                ...
                if 'Random question generator with answer'.lower() in table.rows[0].cells[0].text.lower():
                    ...
                    messages.error(
                        request, f'Random question generator with answer in Lesson {lesson_number}, Screen {screen_number}, add content {table.rows[0].cells[0].text}')
                ...
                if 'Image Carousel block'.lower() in table.rows[0].cells[0].text.lower():
                    ...
                    messages.error(
                        request, f'Image Carousel block card with answer in Lesson {lesson_number}, Screen {screen_number}, add content {table.rows[0].cells[0].text}')
                ...
                if 'Sound block'.lower() in table.rows[0].cells[0].text.lower():
                    ...
                    messages.error(
                        request, f'Sound block card with answer in Lesson {lesson_number}, Screen {screen_number}, add content {table.rows[0].cells[0].text}')
                ...
                if 'Download block'.lower() in table.rows[0].cells[0].text.lower():
                    ...
                    messages.error(
                        request, f'Download block card with answer in Lesson {lesson_number}, Screen {screen_number}, add content {table.rows[0].cells[0].text}')
                ...
                if 'GLOSSARY'.lower() in table.rows[0].cells[0].text.lower():
                    ...
                    messages.error(
                        request, f'GLOSSARY card with answer in Lesson {lesson_number}, Screen {screen_number}, add content {table.rows[0].cells[0].text}')
                ...
                if 'Static text – TEST YOURSELF (for past paper questions only)'.lower() in table.rows[0].cells[0].text.lower():
                    ...
                    messages.error(
                        request, f'TEST YOURSELF card with answer in Lesson {lesson_number}, Screen {screen_number}, add content {table.rows[0].cells[0].text}')
                ...
                if 'Static text – MARK YOURSELF  (for past paper questions only)'.lower() in table.rows[0].cells[0].text.lower():
                    ...
                    messages.error(
                        request, f'MARK YOURSELF card with answer in Lesson {lesson_number}, Screen {screen_number}, add content {table.rows[0].cells[0].text}')
                ...
                if 'True or False'.lower() in table.rows[0].cells[0].text.lower():
                    ...
                    messages.error(
                        request, f'True or False card with answer in Lesson {lesson_number}, Screen {screen_number}, add content {table.rows[0].cells[0].text}')
